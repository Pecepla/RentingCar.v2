...
public class DelegationEndpoint {
    ...
    public void saveDelegation(Delegation delegation) {
        ...
        delegationMap.put("delegationId", AttributeValue.builder().s(delegation.getDelegationId()).build());
        delegationMap.put("operations", AttributeValue.builder().s(delegation.getOperations()).build());
